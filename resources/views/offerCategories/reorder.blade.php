...
@section('content')
@section('breadcrumbs')
    {!! Breadcrumbs::render('reorderCategories') !!}
@stop

<div class="page-content">
    <div class="col-md-12">
        <div class="col-md-9 page-header">
            <h1><i class="menu-icon fa fa-list-ul"></i> أعاده ترتيب أقسام العروض </h1>
        </div>
    </div>
        ...
        <div class="card-block">
            ...
            <span class="disclose"><span></span>
                ...
                <div class="col-md-6 col-md-offset-3">
                    <div class="alert alert-danger" id="error" style="display: none; text-align: center;"> عفوا هناك خطا
                        برجاء المحاوله مجداا
                    </div>
                </div>
                <div class="col-md-6 col-md-offset-3">
                    <div class="alert alert-success" id="success" style="display: none; text-align: center"> تم حفظ
                        الترتيب بنجاح
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#toArray').click(function (e) {
                ...
                // send it with POST
                $.ajax({
                    url: '{{ Route('admin.offerCategories.reorder.save') }}',
                    type: 'POST',
                    data: {tree: arraied},
                })
                    .done(function () {
