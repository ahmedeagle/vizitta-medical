...
<div class="page-content">
    <div class="col-md-12">
        ...
        <div class="col-md-3 top_action top_button">
            <a class="btn btn-white btn-info btn-lg btn-bold" href="{{ route('admin.offers.mainbanners.add') }}">
            ...
            <tbod>
                @if(isset($banners) &&  $banners -> count() > 0)
                    @foreach($banners as $banner)
                        <tr>
                            <td><img style="width: 80px; height: 80px;border-radius:50px;" class="nav-user-photo"
                                     src="{{$banner  -> photo}}"></td>
                            <td>
                                @if($banner -> bannerable_type == 'App\Models\PromoCodeCategory')
                                    اقسام
                                @elseif($banner -> bannerable_type == 'App\Models\PromoCode')
                                    عروض
                                @else
                                    بدون رابط
