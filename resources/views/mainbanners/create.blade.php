...
<div class="page-content">
    ...
    <div class="col-md-12">
        {{ Form::open(['route' => ['admin.offers.mainbanners.save'],'method' => 'POST', 'class' => 'form','files' => true] ) }}
        <div class="col-sm-12">
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-4">
                    <label class="radio-inline" style="user-select: none">
                        <input style="margin: -8px -19px 0 0 " type="radio" value="App\Models\PromoCodeCategory"
                               name="type"
                               id="category">
                        أقسام
                    </label>
                ...
                <div class="col-md-4">
                    <label class="radio-inline" style="user-select: none">
                        <input style="margin: -8px -19px 0 0 " type="radio" value="App\Models\PromoCode" name="type"
                               id="offer"
                            {{  old('offers') == 'App\Models\PromoCode' ? ' checked' : '' }} >
                        عروض
                    </label>
                </div>
                <div class="col-md-4">
                    <label class="radio-inline" style="user-select: none">
                        <input style="margin: -8px -19px 0 0 " type="radio" value="none" name="type" id="no_link">
                        بدون رابط
                    </label>
                </div>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).on('click', '#no_link', function () {
            $('#offer_select').hide();
            $('#category_select').hide();
        });
