...
<div class="page-content">
    <div class="col-md-12">
        ...
        <div class="col-md-3 top_action top_button">
            <a class="btn btn-white btn-info btn-lg btn-bold" href="{{ route('admin.promoCode.filters.create') }}">
                            ...
                            <div class="actions">
                                <div class="col-md-2">
                                    <a class="btn btn-white btn-danger btn-lg"
                                       href="{{ route('admin.promoCode.filters.delete', $filter->id) }}" title="مسح">
                                ...
                                <div class="col-md-2">
                                    <a class="btn btn-white btn-danger btn-lg"
                                       href="{{ route('admin.promoCode.filters.edit', $filter->id) }}"
                                       title=" تعديل الفلتر ">
