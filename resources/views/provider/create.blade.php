...
@section('content')
    @section('breadcrumbs')
        {!! Breadcrumbs::render('add.provider') !!}
    @stop

    <div class="page-content">
        <div class="col-md-12">
            <div class="page-header">
                <h1><i class="menu-icon fa fa-magic"></i> إضافة  مقدم خدمه  </h1>
            </div>
        </div>

        <div class="col-md-12">
            {{ Form::open(['route' => 'admin.provider.store', 'class' => 'form','files' => true]) }}
                @include('provider.form', ['btn' => 'حفظ'])
            {{ Form::close() }}
        </div>
    </div>
@stop
