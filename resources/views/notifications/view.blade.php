...
@section('content')
@section('breadcrumbs')
    {!! Breadcrumbs::render('view.provider.message') !!}
@stop
    ...
    <div class="col-md-12">
        <div class="profile-user-info profile-user-info-striped">
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                    <span class="editable">{{ $message->provider ? $message->provider->name_ar : "" }}</span>
                </div>
            </div>
            ...
            <div class="profile-info-row full">
                ...
                <div class="profile-info-value">
                    <span class="editable">{!! html_entity_decode($message->title) !!}</span>
                </div>
            </div>
        ...
        <div class="col-sm-12 widget-box transparent">
                    ...
                    @foreach($replies as $reply)
                        <div class="timeline-item {{ $reply->FromUser ==  0 ? "" : "reply" }} clearfix">
                            ...
                            <div class="widget-box transparent">
                                <div class="widget-header widget-header-small">
                                    <h5 class="widget-title smaller">{{ $reply->FromUser == 0 ? "أنت" : "مقد الخدمة " }}</h5>
            ...
            <div class="col-sm-12 widget-box transparent">
                ...
                {{ Form::open(['route' => 'admin.provider.message.reply', 'class' => 'form']) }}
                {{ Form::hidden('ticket_id', $message->id) }}
                <div class="form-group col-sm-12">
                    {{ Form::textarea('message', old('message'), ['id' => 'message', 'required' => 'required', 'class' => 'form-control ' . ($errors->has('message') ? 'redborder' : '') ]) }}
