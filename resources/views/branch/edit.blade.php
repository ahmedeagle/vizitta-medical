...
@section('title', 'تعديل فرع مقدم الخدمة')
...
<div class="page-content">
    <div class="col-md-12">
        <div class="page-header">
            <h1><i class="menu-icon fa fa-pencil"></i> تعديل فرع مقدم الخدمة </h1>
        </div>
    </div>

    <div class="col-md-12">
        {{ Form::model($branch, ['route' => ['admin.branch.update' , $branch->id], 'class' => 'form', 'method' => 'PUT']) }}
            @include('branch.form', ['btn' => 'حفظ', 'classes' => 'btn btn-primary'])
        {{ Form::close() }}
    </div>
</div>
@stop
    ...
    <script>
        ...
        function initAutocomplete() {
            ...
            if($('#latitudef').val() === "" && $('#longitudef').val() === ""){
                ...
                infoWindow.setContent("{{$branch -> address ? $branch -> address  :  'موقعك  الحالي '}}");
