...
class DoctorTime extends Model
{
    ...
    protected $fillable = ['day_name', 'day_code', 'from_time', 'to_time', 'doctor_id', 'reservation_period','provider_id', 'order'];

    protected $hidden = ['doctor_id', 'updated_at', 'created_at', 'provider_id','reservation_period', 'order'];
