...
class ServiceReservation extends Model
{
    ...
    protected $appends = ['for_me', 'branch_name', 'branch_no', 'is_reported', 'mainprovider', 'admin_value_from_reservation_price_Tax', 'reservation_total', 'rejected_reason_msg'];
...
//        return $this->belongsTo('App\Models\Provider', 'branch_id')->whereNotNull('provider_id')->withDefault(["name" => ""]);
    ...
    public function getRejectedReasonMsgAttribute()
    {
