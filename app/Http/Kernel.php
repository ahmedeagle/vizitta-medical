...
use App\Http\Middleware\CheckDoctorToken;
use App\Http\Middleware\CheckManagerToken;
use App\Http\Middleware\CheckPassword;
use App\Http\Middleware\CheckProviderToken;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'CheckProviderToken' => CheckProviderToken::class,
        'CheckUserStatus' => CheckUserStatus::class,
        'CheckProviderStatus' => CheckProviderStatus::class,
        ...
        'setAPILocale' => \App\Http\Middleware\SetAPILocale::class,
        'CheckManagerToken' => CheckManagerToken::class,
        'CheckDoctorToken' => CheckDoctorToken::class,
    ];
